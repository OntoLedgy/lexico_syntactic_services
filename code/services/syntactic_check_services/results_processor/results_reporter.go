...
func (results_processor *resultsProcessor) Report_syntactic_check_outputs() {
	...
	syntactic_check_result_report :=
		Prepare_syntactic_checks_results_transactions(
			syntactic_check_result_transactions.Issue_transactions,
			syntactic_check_result_transactions.Fix_transactions)
