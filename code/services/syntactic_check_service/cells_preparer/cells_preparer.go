...
func Get_in_scope_identified_cells(
	run_configuration *configuration_handler.Configurations) object_model.ListOfInScopeCells {
...
func prepare_in_scope_identified_cells_data(
	...
	cell_value_column_name string) object_model.ListOfInScopeCells {

	fmt.Printf(
		"\nReading CSV Data..")

	var in_scope_cells object_model.ListOfInScopeCells
